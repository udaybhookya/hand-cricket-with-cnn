...
class Classifier {
  ...
  final String _labelsFileName = 'assets/tflite/labels.txt';
  ...
  String get modelName => 'tflite/converted_model.tflite';
  ...
  TensorImage _preProcess() {
    // int cropSize = 64; //min(_inputImage.height, _inputImage.width);
